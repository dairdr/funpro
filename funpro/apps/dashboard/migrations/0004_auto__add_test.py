...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('test', (
            ...
            ('name', self.gf('django.db.models.fields.TextField')(max_length='300', null=True, db_column='name')),
            ('option_a', self.gf('django.db.models.fields.TextField')(max_length='300', null=True, db_column='option_a')),
            ('option_b', self.gf('django.db.models.fields.TextField')(max_length='300', null=True, db_column='option_b')),
        ))
