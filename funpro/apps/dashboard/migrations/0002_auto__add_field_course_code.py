...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dashboard_course', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, db_column='code'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.code'
        db.delete_column('dashboard_course', 'code')
    ...
    models = {
        ...
        u'dashboard.course': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '45', 'null': 'True', 'db_column': "'code'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
